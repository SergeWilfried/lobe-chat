...
- **📘 Pluging SDK Documentation**: [https://chat-plugin-sdk.mongriot.com](https://chat-plugin-sdk.mongriot.com)
...
[manifest-docs-url]: https://chat-plugin-sdk.mongriot.com/guides/plugin-manifest
