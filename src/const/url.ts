...
export const OFFICIAL_URL = 'https://chat-preview.mongriot.com/';
...
export const DOCUMENTS = !!LOBE_CHAT_DOCS ? '/docs' : 'https://chat-docs.mongriot.com';
...
export const PRIVACY_URL = 'https://mongriot.com/privacy';

export const PLUGINS_INDEX_URL = 'https://chat-plugins.mongriot.com';
